...
This project analyzes a dataset (medical_examination.csv) containing information about medical examinations. 
The script generates two visualizations to explore potential relationships between various health factors and cardiovascular disease:
